    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authorize -> authorize
                        .requestMatchers("/login", "/public/**", "/h2-console/**").permitAll()  // Allow unauthenticated access to login, public pages, and H2 console
                ...
                .headers(headers -> headers.frameOptions().disable());      // Allow use of frames for H2 console
